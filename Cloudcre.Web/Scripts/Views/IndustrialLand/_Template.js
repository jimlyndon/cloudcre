    ...
    $(function () {
        ...
        cloudcre.App = (function () {
            ...
            module.binding = function (json) {
                ...
                cloudcre.viewModel.CostPerSiteSquareFoot = ko.dependentObservable(function () {
                    return (this.SiteTotalSquareFoot() == 0) ? "" : formatToTwoDecimals(this.Price() / this.SiteTotalSquareFoot());
                }, cloudcre.viewModel);
