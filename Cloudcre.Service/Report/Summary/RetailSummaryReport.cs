...
namespace Cloudcre.Service.Report.Summary
{
    public class RetailSummaryReport : SummaryReport<RetailViewModel>
    {
        protected override void BuildHeaderPrimary(SheetData sheetData1, SharedStringTablePart sharedStringTablePart)
        {
            ...
            cellValue1.Text = sharedStringTablePart.SharedString("COMPARABLE RETAIL PROPERTY SALES");
            ...
            cellValue14.Text = sharedStringTablePart.SharedString("Quality");
            ...
            var cellValue27 = new CellValue { Text = sharedStringTablePart.SharedString("$/SF Land") };
            ...
            var cellValue301 = new CellValue { Text = sharedStringTablePart.SharedString("AADT") };

            cell140.Append(cellValue301);
        ...
        protected override MergeCells BuildProperties(SheetData sheetData1, SharedStringTablePart sstb, IEnumerable<RetailViewModel> viewModels)
        {
            #region rows
